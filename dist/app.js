...
var _componentsSearchBox = require('./components/search-box');

var _componentsSearchBox2 = _interopRequireDefault(_componentsSearchBox);

var _componentsMenuTop = require('./components/menu-top');

var _componentsMenuTop2 = _interopRequireDefault(_componentsMenuTop);

_react2['default'].render(_react2['default'].createElement(
	'div',
	null,
	_react2['default'].createElement(_componentsMenuTop2['default'], null),
	_react2['default'].createElement(_componentsSearchBox2['default'], null)
), document.body);

},{"./components/menu-top":160,"./components/search-box":161,"react":156}],158:[function(require,module,exports){
'use strict';
...
var _welcomeMessage = require('./welcome-message');

var _welcomeMessage2 = _interopRequireDefault(_welcomeMessage);

var _authLinks = require('./auth-links');
...
var AuthBox = (function (_React$Component) {
  ...
  AuthBox.prototype.componentWillMount = function componentWillMount() {
    this.setState({
      fbref: new Firebase(this.props.fburi)
    });
  };

  AuthBox.prototype.authDataCallback = function authDataCallback(authData) {
    if (authData) {
  ...
  AuthBox.prototype.handleTwitterAuth = function handleTwitterAuth(e) {
  ...
  AuthBox.prototype.handleLoggout = function handleLoggout(e) {
    this.state.fbref.unauth();
  };

  AuthBox.prototype.render = function render() {
    return _react2['default'].createElement(
      'div',
      null,
      this.state.username ? _react2['default'].createElement(_welcomeMessage2['default'], { username: this.state.username, loggoutHandler: this.handleLoggout }) : _react2['default'].createElement(_authLinks2['default'], { authHandler: this.handleTwitterAuth })
    );
  };
...
},{"./auth-links":159,"./welcome-message":162,"react":156}],159:[function(require,module,exports){
'use strict';
...
var AuthLinks = (function (_React$Component) {
  ...
  AuthLinks.prototype.render = function render() {
    return _react2['default'].createElement(
      'div',
      null,
...
var MenuTop = (function (_React$Component) {
  ...
  MenuTop.prototype.render = function render() {
    return _react2['default'].createElement(
      'ul',
      null,
      _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'li',
        null,
        _react2['default'].createElement(_authBox2['default'], { fburi: 'https://tutobel.firebaseio.com/' })
      ),
      _react2['default'].createElement(
        'li',
        null,
...
},{"./auth-box":158,"react":156}],161:[function(require,module,exports){
"use strict";
  ...
  SearchBox.prototype.render = function render() {
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        _react2["default"].createElement("input", { type: "button", value: "Chercher" })
      )
    );
  };
